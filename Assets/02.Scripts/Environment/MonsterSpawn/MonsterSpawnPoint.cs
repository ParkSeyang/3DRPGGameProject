...
public class MonsterSpawnPoint : MonoBehaviour
{
    ...
    public void OnMonsterSpawned(GameObject monster)
    {
        ...
        if (monster.TryGetComponent<Mushroom>(out var mushroom)) 
        {
            mushroom.SetSpawnPoint(this);
        }
        else if (monster.TryGetComponent<Slime>(out var slime)) 
        {
            slime.SetSpawnPoint(this);
        }
        else if (monster.TryGetComponent<WildBoar>(out var wildBoar)) 
        {
